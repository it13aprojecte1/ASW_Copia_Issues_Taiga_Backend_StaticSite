  ...
  module V1
    class IssuesController < ApplicationController
      ...
      def index
        ...
        # Preparar issues con watcher_ids y assignee_id
        issues_with_ids = @issues.map do |issue|
          issue_json = issue.as_json(include: {
            issue_type: {},
            severity: {},
            priority: {},
            status: {},
          ...
          # Añadir solo el ID del asignado
          issue_json['assignee_id'] = issue.assignee_id
          # Añadir solo los IDs de los watchers
          issue_json['watcher_ids'] = issue.watchers.pluck(:id)
          issue_json
        end

        render json: issues_with_ids
      end

      # GET /api/v1/issues/:id
      def show
        # Preparar issue con watcher_ids
        issue_json = @issue.as_json(include: {
          issue_type: {},
          severity: {},
          priority: {},
